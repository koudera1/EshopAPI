...
```bash
curl -X GET \
    -G "http://localhost/orders/illo/invoice" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://localhost/orders/illo/invoice"
);
...
```json
{
    "message": "No query results for model [App\\Models\\Order] illo",
...
```bash
curl -X GET \
    -G "http://localhost/orders/enim/history" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://localhost/orders/enim/history"
);
...
```json
{
    "message": "No query results for model [App\\Models\\Order] enim",
    "exception": "Symfony\\Component\\HttpKernel\\Exception\\NotFoundHttpException",
    "file": "C:\\Users\\koude\\Eshop\\vendor\\laravel\\framework\\src\\Illuminate\\Foundation\\Exceptions\\Handler.php",
    "line": 365,
    "trace": [
...
```bash
curl -X POST \
    "http://localhost/orders/natus/history" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://localhost/orders/ut/history/quae" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://localhost/orders/ut/history/quae"
);
...
```bash
curl -X DELETE \
    "http://localhost/orders/quam/history/laboriosam" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
